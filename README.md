...
<b>1. Mayra Garg</a> :</b> Developed the models for the classification of vehicles and implemented the YOLO-based model. <br/><br/>
<b>2. Nishant Yadav</a> : </b> Worked on deploying ML models and using it in reactJS application, and ML deployment using AWS. Worked on OCR for text extraction from images,face emotion detection.  <br/><br/>
<b>3. Aadithya Narain</a> : </b> Designed customizable simulator software for visually impaired users, enhancing smart device accessibility with ML models. Also worked on connection of the model and the web software.  <br/><br/>
<b>4. Shrishti Saha</a> :</b> Developed a seamless user simulator with React JS and vanilla CSS, created a currency detection model, implemented audio input and output features. <br/><br/>
